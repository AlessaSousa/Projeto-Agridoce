...
<body>
    ...
    <div class="container-p">
        <div class="box-p form-box-p">
            <header>INGREDIENTES</header><br>
        <form action="" method="POST">
        <div class="field-p input-p">
            <input type="text" id="inserir-novo" placeholder="Digite seu ingrediente">
        </div>
        <div class="field-p">
            <button class="btn-login-p" onclick="newTask()" id="btn" title="Adicione">

        <!-- aplicado um icone do boostrap -->
      ...
      <div class="container-p">
        <div class="box-p form-box-p">
            <header>MODO DE PREPARO</header><br>
        <form action="" method="POST">
        <div class="field-p input-p">
            <input type="text" id="inserir-novo" placeholder="Digite seu ingrediente">
        </div>
